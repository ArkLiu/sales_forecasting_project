/* Formatted on 10/4/2016 3:57:14 PM (QP5 v5.287) */
DECLARE
...
BEGIN
   ...
   FOR rec_lag_period IN cur_lag_period (p_predict_month, 2)
   LOOP
      ...
      FOR rec_sales_history
         IN cur_sales_history (lv_cm_name, lv_item_added_date)
      LOOP
         -- Show Line
         lv_line_text :=
               '"'
